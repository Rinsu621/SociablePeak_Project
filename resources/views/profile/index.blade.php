                    ...
                    <div class="profile-header">
                        ...
                        <div class="user-detail text-center mb-3">
                            <div class="profile-img">
                                <img src="{{ asset('/images/template/user/11.png') }}" alt="profile-img"
                        ...
                        <div class="profile-info p-3 d-flex align-items-center justify-content-between position-relative">
                            <div class="social-links">
                                <ul
                                    ...
                                    <li class="text-center pe-3">
                                        <a href="#"><img src="{{ asset('/images/template/icon/11.png') }}"
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <ul class="profile-img-gallary p-0 m-0 list-unstyled">
                                            <li class=""><a href="#"><img
                                                        src="{{ asset('/images/template/page-img/g1.jpg') }}"
                                                        alt="gallary-image" class="img-fluid" /></a></li>
                                            <li class=""><a href="#"><img
                                                        src="{{ asset('/images/template/page-img/g2.jpg') }}"
                                                        alt="gallary-image" class="img-fluid" /></a></li>
                                            <li class=""><a href="#"><img
                                                        src="{{ asset('/images/template/page-img/g3.jpg') }}"
                                                        alt="gallary-image" class="img-fluid" /></a></li>
                                            <li class=""><a href="#"><img
                                                        src="{{ asset('/images/template/page-img/g4.jpg') }}"
                                                        alt="gallary-image" class="img-fluid" /></a></li>
                                            <li class=""><a href="#"><img
                                                        src="{{ asset('/images/template/page-img/g5.jpg') }}"
                                                        alt="gallary-image" class="img-fluid" /></a></li>
                                            <li class=""><a href="#"><img
                                                        src="{{ asset('/images/template/page-img/g6.jpg') }}"
                                                        alt="gallary-image" class="img-fluid" /></a></li>
                                            <li class=""><a href="#"><img
                                                        src="{{ asset('/images/template/page-img/g7.jpg') }}"
                                                        alt="gallary-image" class="img-fluid" /></a></li>
                                            <li class=""><a href="#"><img
                                                        src="{{ asset('/images/template/page-img/g8.jpg') }}"
                                                        alt="gallary-image" class="img-fluid" /></a></li>
                                            <li class=""><a href="#"><img
                                                        src="{{ asset('/images/template/page-img/g9.jpg') }}"
                                                        alt="gallary-image" class="img-fluid" /></a></li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class=" post-opt-block d-flex list-inline m-0 p-0 flex-wrap">
                                        <li
                                            ...
                                            <img src="{{ asset('/images/template/small/07.png') }}" alt="icon"
                                                class="img-fluid me-2"> Photo/Video</li>
                                        <li
                                            class="bg-soft-primary rounded p-2 pointer d-flex align-items-center me-3 mb-md-0 mb-2">
                                            <img src="{{ asset('/images/template/small/08.png') }}" alt="icon"
                                                class="img-fluid me-2"> Tag Friend</li>
                                        <li class="bg-soft-primary rounded p-2 pointer d-flex align-items-center me-3">
                                            <img src="{{ asset('/images/template/small/09.png') }}" alt="icon"
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right"
                                                        ...
                                                        <a class="dropdown-item" href="#"
                                                            data-bs-toggle="modal" data-bs-target="#post-modal">Check
                                                            in</a>
                                                        <a class="dropdown-item" href="#"
                                                            data-bs-toggle="modal" data-bs-target="#post-modal">Live
                                                            Video</a>
                                                        <a class="dropdown-item" href="#"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#post-modal">Gif</a>
                                                        <a class="dropdown-item" href="#"
                                                            data-bs-toggle="modal" data-bs-target="#post-modal">Watch
                                                            Party</a>
                                                        <a class="dropdown-item" href="#"
                                                            data-bs-toggle="modal" data-bs-target="#post-modal">Play
                                                            with Friend</a>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('postStore') }}" method="post">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <input type="text" class="form-control rounded"
                                                            name="description" placeholder="Write something here..."
                                                            style="border:none;">
                                                        {{-- </form> --}}
                                                    </div>
                                                    <hr>
                                                    <ul
                                                        ...
                                                        <li class="col-md-6 mb-3">
                                                            <div class="bg-soft-primary rounded p-2 pointer me-3"><a
                                                                    href="#"></a><img
                                                                    src="{{ asset('/images/template/small/07.png') }}"
                                                        ...
                                                        <li class="col-md-6 mb-3">
                                                            <div class="bg-soft-primary rounded p-2 pointer me-3"><a
                                                                    href="#"></a><img
                                                                    src="{{ asset('/images/template/small/08.png') }}"
                                                                    alt="icon" class="img-fluid"> Tag Friend</div>
                                                        </li>
                                                        <li class="col-md-6 mb-3">
                                                            <div class="bg-soft-primary rounded p-2 pointer me-3"><a
                                                                    href="#"></a><img
                                                                    src="{{ asset('/images/template/small/09.png') }}"
                                                        ...
                                                        <li class="col-md-6 mb-3">
                                                            <div class="bg-soft-primary rounded p-2 pointer me-3"><a
                                                                    href="#"></a><img
                                                                    src="{{ asset('/images/template/small/10.png') }}"
                                                                    alt="icon" class="img-fluid"> Check in</div>
                                                        </li>
                                                        <li class="col-md-6 mb-3">
                                                            <div class="bg-soft-primary rounded p-2 pointer me-3"><a
                                                                    href="#"></a><img
                                                                    src="{{ asset('/images/template/small/11.png') }}"
                                                                    alt="icon" class="img-fluid"> Live Video</div>
                                                        </li>
                                                        <li class="col-md-6 mb-3">
                                                            <div class="bg-soft-primary rounded p-2 pointer me-3"><a
                                                                    href="#"></a><img
                                                                    src="{{ asset('/images/template/small/12.png') }}"
                                                                    alt="icon" class="img-fluid"> Gif</div>
                                                        </li>
                                                        <li class="col-md-6 mb-3">
                                                            <div class="bg-soft-primary rounded p-2 pointer me-3"><a
                                                                    href="#"></a><img
                                                                    src="{{ asset('/images/template/small/13.png') }}"
                                                        ...
                                                        <li class="col-md-6 mb-3">
                                                            <div class="bg-soft-primary rounded p-2 pointer me-3"><a
                                                                    href="#"></a><img
                                                                    src="{{ asset('/images/template/small/14.png') }}"
                                                    ...
                                                    <div class="d-flex justify-content-between">
                                                        <div class="me-3">
                                                            <img class="rounded-circle avatar-60"
                                                                src="{{ asset('/images/template/user/1.jpg') }}"
                                                                alt="">
                                                        </div>
                                                        <div class="w-100">
                                                            <div class="d-flex justify-content-between">
                            ...
                            <div class="card-body p-0">
                                <div class="d-grid gap-2 d-grid-template-1fr-13">
                                    ...
                                    <div class="">
                                        <div class="user-images position-relative overflow-hidden">
                                            <a href="#">
                                                <img src="{{ asset('/images/template/page-img/52.jpg') }}"
                                                    class="img-fluid rounded" alt="Responsive image">
                                            </a>
                                            <div class="image-hover-data">
                                                <div class="product-elements-icon">
                                    ...
                                    <div class="">
                                        <div class="user-images position-relative overflow-hidden">
                                            <a href="#">
                                                <img src="{{ asset('/images/template/page-img/53.jpg') }}"
                                                    class="img-fluid rounded" alt="Responsive image">
                                            </a>
                                            <div class="image-hover-data">
                                                <div class="product-elements-icon">
                                    ...
                                    <div class="">
                                        <div class="user-images position-relative overflow-hidden">
                                            <a href="#">
                                                <img src="{{ asset('/images/template/page-img/54.jpg') }}"
                                                    class="img-fluid rounded" alt="Responsive image">
                                            </a>
                                            <div class="image-hover-data">
                                                <div class="product-elements-icon">
                                    ...
                                    <div class="">
                                        <div class="user-images position-relative overflow-hidden">
                                            <a href="#">
                                                <img src="{{ asset('/images/template/page-img/55.jpg') }}"
                                                    class="img-fluid rounded" alt="Responsive image">
                                            </a>
                                            <div class="image-hover-data">
                                                <div class="product-elements-icon">
                                    ...
                                    <div class="">
                                        <div class="user-images position-relative overflow-hidden">
                                            <a href="#">
                                                <img src="{{ asset('/images/template/page-img/56.jpg') }}"
                                                    class="img-fluid rounded" alt="Responsive image">
                                            </a>
                                            <div class="image-hover-data">
                                                <div class="product-elements-icon">
                                    ...
                                    <div class="">
                                        <div class="user-images position-relative overflow-hidden">
                                            <a href="#">
                                                <img src="{{ asset('/images/template/page-img/57.jpg') }}"
                                                    class="img-fluid rounded" alt="Responsive image">
                                            </a>
                                            <div class="image-hover-data">
                                                <div class="product-elements-icon">
                                    ...
                                    <div class="">
                                        <div class="user-images position-relative overflow-hidden">
                                            <a href="#">
                                                <img src="{{ asset('/images/template/page-img/58.jpg') }}"
                                                    class="img-fluid rounded" alt="Responsive image">
                                            </a>
                                            <div class="image-hover-data">
                                                <div class="product-elements-icon">
                                    ...
                                    <div class="">
                                        <div class="user-images position-relative overflow-hidden">
                                            <a href="#">
                                                <img src="{{ asset('/images/template/page-img/59.jpg') }}"
                                    ...
                                    <div class="">
                                        <div class="user-images position-relative overflow-hidden">
                                            <a href="#">
                                                <img src="{{ asset('/images/template/page-img/60.jpg') }}"
                                                    class="img-fluid rounded" alt="Responsive image">
                                            </a>
                                            <div class="image-hover-data">
                                                <div class="product-elements-icon">
                                    ...
                                    <div class="">
                                        <div class="user-images position-relative overflow-hidden">
                                            <a href="#">
                                                <img src="{{ asset('/images/template/page-img/61.jpg') }}"
                                                    class="img-fluid rounded" alt="Responsive image">
                                            </a>
                                            <div class="image-hover-data">
                                                <div class="product-elements-icon">
                                    ...
                                    <div class="">
                                        <div class="user-images position-relative overflow-hidden">
                                            <a href="#">
                                                <img src="{{ asset('/images/template/page-img/62.jpg') }}"
                                                    class="img-fluid rounded" alt="Responsive image">
                                            </a>
                                            <div class="image-hover-data">
                                                <div class="product-elements-icon">
                                    ...
                                    <div class="">
                                        <div class="user-images position-relative overflow-hidden">
                                            <a href="#">
                                                <img src="{{ asset('/images/template/page-img/63.jpg') }}"
                                                    class="img-fluid rounded" alt="Responsive image">
                                            </a>
                                            <div class="image-hover-data">
                                                <div class="product-elements-icon">
                                    ...
                                    <div class="">
                                        <div class="user-images position-relative overflow-hidden">
                                            <a href="#">
                                                <img src="{{ asset('/images/template/page-img/64.jpg') }}"
                                                    class="img-fluid rounded" alt="Responsive image">
                                            </a>
                                            <div class="image-hover-data">
                                                <div class="product-elements-icon">
                                    ...
                                    <div class="">
                                        <div class="user-images position-relative overflow-hidden">
                                            <a href="#">
                                                <img src="{{ asset('/images/template/page-img/65.jpg') }}"
                                                    class="img-fluid rounded" alt="Responsive image">
                                            </a>
                                            <div class="image-hover-data">
                                                <div class="product-elements-icon">
