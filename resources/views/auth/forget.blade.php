            ...
            <div class="row no-gutters">
                ...
                <div class="col-md-6 bg-white pt-5 pt-5 pb-lg-0 pb-5">
                    <div class="sign-in-from">
                        ...
                        @endif
                        <form action="{{ route('forgetPasswordPost') }}" method="POST" class="mt-4">
                            @csrf
                            <div class="form-group">
                                <label class="form-label" for="exampleInputEmail1">Email address</label>
                                <input name="email" type="email" class="form-control mb-0" id="exampleInputEmail1" name="email">
                            </div>

                                <button type="submit" class="btn btn-primary float">Send Reset Link</button>
                            </div>
                            <div class="sign-info" style="padding-left: 20px ">
