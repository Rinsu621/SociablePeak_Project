...
<div class="container">
    <h3>
        <span style="color: gray">
            Trending Posts <i class="fa-solid fa-fire" style="color: #f29d26;"></i>
        </span>
    </h3>
    <hr>
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="me-3 user-img">
                                    @if($post->user && $post->user->profilePicture && $post->user->profilePicture->file_path)
                                        <img src="{{ Storage::url($post->user->profilePicture->file_path) }}" alt="profile-img" class="avatar-60 img-fluid rounded-circle" style="width:55px;height:55px;object-fit:cover;">
                                    @else
                                        <img src="{{ asset('/images/template/user/Noprofile.jpg') }}" alt="profile-img" class="avatar-60 img-fluid rounded-circle" style="width:55px;height:55px;object-fit:cover;">
                                    @endif
                                </div>
                                <div class="w-100">
                                    <div class="d-flex justify-content-between">
