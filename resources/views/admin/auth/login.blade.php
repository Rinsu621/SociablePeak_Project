              ...
              <div class="sign-in-from" style="margin-top: 100px;">
                ...
                <form action="{{ route('admin.login.post') }}" method="POST" class="mt-4">
                  ...
                  <div class="form-group">
                    ...
                    <input name="email" type="email" class="form-control mb-0" id="email" placeholder="Enter email">
                  </div>
                  <div class="form-group">
                    <label class="form-label" for="password">Password</label>
                    <a href="#" class="float-end">Forgot password?</a> <!-- Add route for admin password reset if needed -->
